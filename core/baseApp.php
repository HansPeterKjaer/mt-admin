...
class BaseApp{
	...
	function createController()
	{
		...
		// Get controller and 
		$controllerName = $pathSegments[0] . 'Controller';	
		array_shift($pathSegments);
		
		$actionName = (count($pathSegments) > 0) ?  $pathSegments[0] . 'Action' : 'indexAction';		
		array_shift($pathSegments);
		...
		try{
			...
			$controller = new $controllerName($modelFactory, new Auth($this->dbhandle));
