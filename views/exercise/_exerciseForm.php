...
<form id="exercise-form" class="form-horizontal ajax-form" method="POST" action="<?php isset($ex) ? URLHelper::renderUrl('AdminExercise/update') : URLHelper::renderUrl('AdminExercise/insert'); ?>">
	...
	<div class="form-group">
		<label for="inputDiff" class="col-sm-4 col-lg-2 control-label" >Cardio/Styrke Forhold</label> 
		<div class="col-sm-4">
	...
	<div class="form-group">
		<label for="inputFocus" class="col-sm-4 col-lg-2 control-label">Fokus</label>   
		<div class="col-sm-4">
	...
	<div class="form-group">
		<label for="inputDescr" class="col-sm-4 col-lg-2 control-label">Beskrivelse</label>
		<div class="col-sm-8 col-lg-6"> 
	...
	<div class="form-group ">
		<div class="col-sm-8 col-sm-offset-4 col-lg-10 col-lg-offset-2">
				<div id="exercise-images" class="mt-panel item-composer small-gutters" data-select-elm="#image-composer-select">
					<?php 
