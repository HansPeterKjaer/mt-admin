...
<form id="workout-form" class="form form-horizontal ajax-form" method="POST" action="<?php ($wo->id != null) ? URLHelper::renderUrl('Workout/update') : URLHelper::renderUrl('Workout/insert'); ?>" >
		...
		<div class="col-sm-8 col-md-6">
			<div class="input-group import-status">
				...
				<span class="input-group-btn">
					<button class="btn btn-default btn-import-exercise" for="input-import-exercise" data-url="<?php URLHelper::renderUrl('adminexercise/ExerciseJSON?controls=true'); ?>" disabled="true" type="button">Importer øvelse</button>
				</span>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-sm-8 col-sm-offset-4 col-md-10 col-md-offset-2">    
			<div id="workout-exercises" class="mt-panel item-composer small-gutters" data-select-elm="#composer-select"> 
				<?php 
