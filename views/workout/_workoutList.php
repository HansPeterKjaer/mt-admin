...
?>
		<tr>
			...
			<td>
				<a class="btn btn-sm btn-danger ajax-delete" data-url="<?php URLHelper::renderUrl("Workout/delete/"); ?>" data-id="<?php echo $wo->id ?>" href="#"><i class="glyphicon glyphicon-trash icon-white"></i> Slet</a>
				<a class="btn btn-sm btn-success" href="<?php URLHelper::renderUrl("Workout/edit/$wo->id"); ?>"><i class="glyphicon glyphicon-edit icon-white"></i> Rediger</a>
			</td>
		</tr>
<?php
	} 
