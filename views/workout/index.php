...
<table class="table table-striped">
	...
	<tbody class="ajax-panel" data-url="//localhost/mt/AdminWorkout/workoutListJson" data-filter-class="ajax-panel-filter" data-search-id="ajax-panel-search-input" data-search-btn-id="ajax-panel-search-btn" data-load-more-btn-id="ajax-panel-load-more" data-sort-class="ajax-panel-sort" >
