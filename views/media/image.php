...
<div class="row">
	<div class="col-xs-12 imagecontainer">
		<div class="thumbnail">
			<img src="<?php URLHelper::renderUrl("/mtassets/exercise-images/{$viewModel->MediaItem->imageName}"); ?>" data-id="<?php echo($viewModel->MediaItem->id) ?>" />
			<div class="caption">
		    	...
		    	<span class="btn btn-success btn-file">
    				Opdater billede<input class="btn-upload-image" type="file" data-target-url="<?php URLHelper::renderUrl('mt/Media/updateImage/'); ?>" data-target-id="<?php echo($viewModel->MediaItem->id) ?>">
				</span>
