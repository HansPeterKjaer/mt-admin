  	...
  	<div class="btn-toolbar pull-right">
	    <div class="btn-group">
	    	<span class="btn btn-success btn-lg btn-file">
    			Upload billede<input class="btn-upload-image" type="file" data-target-url="/mt/Media/insertImageJSON/"></input>
			</span>
	    </div>
	</div>
	<h1>Mediearkiv</h1>
...
<div class="row">
	<div class="col-xs-12">
		<div class="row">
			<div id="exercise-images" class="ajax-panel" data-url="//localhost/mt/Media/imagePanelJson" data-filter-class="ajax-panel-filter" data-search-id="ajax-panel-search" data-search-btn-id="ajax-panel-search-btn" data-load-more-btn-id="ajax-panel-load-more" data-sort-class="ajax-panel-sort"  >
			<?php 
