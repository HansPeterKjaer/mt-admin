...
class AppController extends BaseController {
	public function WorkoutAction($wo_id){
		$viewModel = null;
		...
		/*ob_start();
			$this->view->output('/appViews/_workout', $workoutModel, false);			 
		$html = ob_get_clean();
		echo $html;*/
		//$this->view->outputJSON(['html' => $html, 'status' => $status]);
	}

	public function GenerateWorkoutAction($diff = null, $focus = null, $time = null){
